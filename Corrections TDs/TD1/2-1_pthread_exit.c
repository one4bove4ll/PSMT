...
void affiche_courroux(int *N)
{
    ...
    pthread_exit(NULL);     /* Non nécessaire, est effectué automatiquement */
}
...
int main(int argc, char **argv)
{
    ...
    /* Permet aux autres threads de poursuivre leurs exécutions
     * Attention, N est dans l'espace mémoire du thread principal
     * qui peut être modifié après le pthread_exit */
    pthread_exit(NULL);
